...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 8
        //creating a new span tag and passing the user score number and total question number
        let scoreTag = '<span>e Parabés! 🎉, Acertaste <p>'+ userScore +'</p> de um total de <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if(userScore > 1){ // if user scored more than 5
        let scoreTag = '<span>não foi péssimo 😎, Acertaste <p>'+ userScore +'</p> de um total de <p>'+ questions.length +'</p></span>';
